        ...
        content = (
            <InfiniteScroll
                ...
                loader={
                    <div className=" flex py-3 items-center justify-center">
                        <div className="w-14 h-14  border-b-2 border-gray-900 rounded-full animate-spin" />
                    </div>
                }
            ...
            >
                {conversations.map((conversation) => {
                    ...
                    const { name, email: partnerEmail } = getPartnerInfo(conversation.users, loggedInUserEmail);
